...
#define portCONFIGURE_TIMER_FOR_RUN_TIME_STATS() TIM_BASE_Init(10-1,9000-1)
#define portGET_RUN_TIME_COUNTER_VALUE() 0xffffffff

#define configOVERRIDE_DEFAULT_TICK_CONFIGURATION 0 //为1时使用非systick中断作为调度时钟
